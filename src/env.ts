...
export const env = createEnv({
  ...
  client: {
    ...
    VITE_PRIVY_APP_ID: z.string().default('cmp07qnn3000y0cjsx7jj6d9u'),
    ...
    VITE_OWNER_ADDRESS_MAINNET: z.string().default('3bsWDcy5VTdoA1UZDy3uvbk32w3xTKj5idqWWxbMWkAF'),
    VITE_OWNER_ADDRESS_DEVNET: z.string().default('3bsWDcy5VTdoA1UZDy3uvbk32w3xTKj5idqWWxbMWkAF'),
